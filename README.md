...
*cachingproxy* - facilitates proxying DNS messages to upstream resolvers.

## Description

The *cachingproxy* plugin re-uses already opened sockets to the upstreams. It supports UDP, TCP and
